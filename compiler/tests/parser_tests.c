...
{
    DEBUG_INFO("\n*** Testing parser_execute empty program...\n");
...
{
    DEBUG_INFO("\n*** Testing parser_execute variable declaration...\n");
...
{
    DEBUG_INFO("\n*** Testing parser_execute function no params...\n");
...
{
    DEBUG_INFO("\n*** Testing parser_execute if statement...\n");
...
{
    DEBUG_INFO("\n*** Testing parser_execute while loop...\n");
...
{
    DEBUG_INFO("\n*** Testing parser_execute for loop...\n");
...
{
    DEBUG_INFO("\n*** Testing parser_execute interpolated string...\n");
...
{
    DEBUG_INFO("\n*** Testing parser_execute various literals...\n");
...
{
    DEBUG_INFO("\n*** Testing parser_execute recursive function...\n");
...
{
    DEBUG_INFO("\n*** Testing parser_execute full program...\n");
    Arena arena;
    Lexer lexer;
    Parser parser;
    SymbolTable symbol_table;
...
void test_simple_program_parsing()
{
    ...
    DEBUG_INFO("\n*** Testing parser_execute simple program...\n");
