...
{
    DEBUG_INFO("\n*** Testing ast_create_primitive_type...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_function_type...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_binary_expr...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_literal_expr...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_variable_expr...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_assign_expr...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_array_access_expr...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_increment_expr...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_decrement_expr...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_interpolated_expr...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_comparison_expr...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_var_decl_stmt...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_function_stmt...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_return_stmt...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_create_import_stmt...\n");
    Arena arena;
    setup_arena(&arena);
...
{
    DEBUG_INFO("\n*** Testing ast_module_add_statement...\n");
    Arena arena;
    setup_arena(&arena);
...
void test_ast_print()
{
    DEBUG_INFO("\n*** Testing ast_print_stmt and ast_print_expr (no crash)...\n");
    Arena arena;
    setup_arena(&arena);
